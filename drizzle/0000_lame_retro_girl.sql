...
CREATE INDEX `idx_participant_team_id` ON `participant` (`team_id`);--> statement-breakpoint
CREATE TABLE `team` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
...
CREATE UNIQUE INDEX `team_name_canonical_unique` ON `team` (`name_canonical`);--> statement-breakpoint
