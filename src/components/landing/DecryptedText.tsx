...
export default function DecryptedText({
  ...
  // Resets the animation whenever `text` or `animateOn` changes — e.g. when the
  // visitor switches language and every string on the page is replaced. The
  // reset has to run as an effect because the scrambled text is derived from
  // the new prop, not from user interaction.
  ...
  useEffect(() => {
    ...
    setRevealedIndices(new Set());
    setDirection('forward');
  }, [animateOn, text, encryptInstantly, shuffleText]);
